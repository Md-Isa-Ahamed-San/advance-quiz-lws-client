            ...
            return (
                <li
                    ...
                    className={`flex items-center justify-between p-4 rounded-md ${
                        isCurrentUser ? "bg-yellow-100 border-2 border-yellow-500" : "bg-white"
                    }`}
                >
                  <div className="flex items-center">
                    ...
                    />
                    <div>
                      <h3 className={`font-semibold ${isCurrentUser ? "text-yellow-800" : ""}`}>
                        {user.username}
                      </h3>
                  ...
                  <div className="flex items-center">
                    <span className="font-bold text-lg text-gray-800">{user.marks}</span>
                  </div>
                </li>
            );
          })}
